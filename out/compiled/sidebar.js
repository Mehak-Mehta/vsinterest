    ...
    function create_default_slot_3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/Sudoku-Solver" class="svelte-1nr8jn4">Sudoku Solver</a> 
	<p>Sudoku Solver Using Backtracing Algorithum</p></li>`;

    			t3 = space();
    			div1 = element("div");

    			div1.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/Account-Storage" class="svelte-1nr8jn4">Account Storage</a> 
	<p>GUI for Account Storage Using tkinter</p></li>`;

    			t7 = space();
    			div2 = element("div");

    			div2.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/Password-Generator" class="svelte-1nr8jn4">PassWord Generator</a> 
	<p>Simple PassWord Generator Using Python</p></li>`;

    			attr(div0, "class", "links svelte-1nr8jn4");
    			attr(div1, "class", "Acc");
    ...
    function create_default_slot_2(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/Apollo-GraphQL-Server" class="svelte-1nr8jn4">Apollo GraphQL Server</a> 
	<p>Apollo graphql server with express and mongoDB</p></li>`;

    			t3 = space();
    			div1 = element("div");

    			div1.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/Express.js-API" class="svelte-1nr8jn4">Express.js API</a></li> 
	<p>REST API Using Node , Express , MongoDB</p>`;

    			t7 = space();
    			div2 = element("div");

    			div2.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/HunterxHunter-Web" class="svelte-1nr8jn4">Hunter x Hunter</a></li> 
	<p>Front-end Hunter x Hunter Web Using React.</p>`;

    			attr(div0, "class", "links svelte-1nr8jn4");
    			attr(div1, "class", "links svelte-1nr8jn4");
    			attr(div2, "class", "links svelte-1nr8jn4");
    		},
    		m(target, anchor) {
    			insert(target, div0, anchor);
    			insert(target, t3, anchor);
    ...
    function create_default_slot_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/Nest-GraphQL-Server" class="svelte-1nr8jn4">Nest GraphQL Server</a> 
	<p>Nest graphql server with mongoDB</p></li>`;

    			t3 = space();
    			div1 = element("div");

    			div1.innerHTML = `<li><a href="https://github.com/benawad/vstodo" class="svelte-1nr8jn4">vstodo</a></li> 
	<p>Todo list for VSCode</p>  <strong>Owner: benawad</strong>`;

    			t9 = space();
    			div2 = element("div");

    			div2.innerHTML = `<li><a href="https://github.com/bradtraversy/deno-rest-api" class="svelte-1nr8jn4">deno rest api</a></li> 
    ...
    function create_default_slot(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0.innerHTML = `<li><a href="https://github.com/Mehak-Mehta/WebTemp" class="svelte-1nr8jn4">Website Template</a> 
	<p>Basic HTML Website</p></li>`;

    			t3 = space();
    			div1 = element("div");

    			div1.innerHTML = `<li><a href="https://github.com/Alicunde/HTML" class="svelte-1nr8jn4">HTML elements</a> 
	<p>Set of simplified and stylized HTML elements</p>  <strong>Owner: Alicunde</strong></li>`;

    			t9 = space();
    			div2 = element("div");

    			div2.innerHTML = `<li><a href="https://github.com/bornmay/Responsive-Portfolio" class="svelte-1nr8jn4">Responsive Portfolio</a> 
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			p1 = element("p");
    			p1.innerHTML = `Here is the <a href="https://github.com/Mehak-Mehta/VSInterest" class="svelte-1nr8jn4">Source Code </a>.`;
    			t7 = text("\r\n\r\n\r\nSelect language: \r\n\r\n\r\n");
    			...
    			t21 = space();
    			div2 = element("div");
    			div2.innerHTML = `Made By <a href="https://github.com/Mehak-Mehta" class="svelte-1nr8jn4">Mehak Mehta</a>`;
    			attr(div0, "class", "header svelte-1nr8jn4");
    		},
    		m(target, anchor) {
    			insert(target, div0, anchor);
